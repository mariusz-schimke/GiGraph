...
public class DotRecordBuilderTest
{
    ...
    public void record_builder_composes_an_expected_record_representation_with_fields_and_subrecords()
    {
        var builder = new DotRecordBuilder()
           ...
           .AppendFields(new[] { "Field_1.3", "Field_1.4" })
           .AppendFields("Field_1.5", "Field_1.6")
           .AppendFields((IEnumerable<DotEscapeString>) new DotEscapeString[] { "Field_1.7", "Field_1.8" })
           .AppendFields((IEnumerable<DotRecordField>) new DotRecordField[] { "Field_1.9", "Field_1.10" })
           .AppendFields(new DotRecordTextField("Field_1.11"), new DotRecordTextField("Field_1.12"))
           .AppendSubrecord(new[] { "Field_1.13.1", "Field_1.13.2" })
           .AppendSubrecord("Field_1.14.1", "Field_1.14.2")
           .AppendSubrecord((IEnumerable<DotEscapeString>) new DotEscapeString[] { "Field_1.15.1", "Field_1.15.2" })
           .AppendSubrecord((IEnumerable<DotRecordField>) new DotRecordField[] { "Field_1.16.1", "Field_1.16.2" })
    ...
    public void record_builder_composes_an_expected_record_representation_with_fields_and_unflipped_subrecords()
    {
        var builder = new DotRecordBuilder()
           ...
           .AppendFields((IEnumerable<DotRecordField>) new DotRecordField[] { "Field_1.9", "Field_1.10" })
           .AppendFields(new DotRecordTextField("Field_1.11"), new DotRecordTextField("Field_1.12"))
           .AppendUnflippedSubrecord(new[] { "Field_1.13.1", "Field_1.13.2" })
           .AppendUnflippedSubrecord("Field_1.14.1", "Field_1.14.2")
           .AppendUnflippedSubrecord((IEnumerable<DotEscapeString>) new DotEscapeString[] { "Field_1.15.1", "Field_1.15.2" })
           .AppendUnflippedSubrecord((IEnumerable<DotRecordField>) new DotRecordField[] { "Field_1.16.1", "Field_1.16.2" })

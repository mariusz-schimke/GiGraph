...
public class DotHtmlBuilderTest
{
    ...
    public void html_builder_generates_valid_html_structure()
    {
        ...
        builder.Append(new DotHtmlFont())
            ...
            .AppendFont(new("arial", 10, Color.Red), f => f.AppendText("font"))
            .AppendStyledFont(new(), f => f.AppendText("styled text"))
            .AppendStyledFont(new(DotFontStyles.Bold, "arial", 10, Color.Red), f => f.AppendText("styled text"))
            ...
            .AppendText("font\n", new("arial", 10, Color.Red), DotHorizontalAlignment.Left)

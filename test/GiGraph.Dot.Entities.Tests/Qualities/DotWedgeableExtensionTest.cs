...
public class DotWedgeableExtensionTest
{
    ...
    public void sets_wedged_fill_on_individual_nodes()
    {
        ...
        graph.Nodes.Add("node1").Style.SetWedgedFill(Color.Red, Color.Blue);
        graph.Nodes.Add("node2").Style.SetWedgedFill(new DotMulticolor(Color.Red, Color.Blue));
    ...
    public void sets_wedged_fill_on_individual_node_groups()
    {
        ...
        graph.Nodes.AddGroup(["node1", "node2"]).Style.SetWedgedFill(Color.Red, Color.Blue);
        graph.Nodes.AddGroup(["node3", "node4"]).Style.SetWedgedFill(new DotMulticolor(Color.Red, Color.Blue));
    ...
    {
        var graph = new DotGraph();
        graph.Nodes.Style.SetWedgedFill(Color.Red, Color.Blue);
        Snapshot.Match(graph.ToDot(), "wedged_fill_on_node_collection_params");

        graph = new DotGraph();
        graph.Nodes.Style.SetWedgedFill(new DotMulticolor(Color.Red, Color.Blue));

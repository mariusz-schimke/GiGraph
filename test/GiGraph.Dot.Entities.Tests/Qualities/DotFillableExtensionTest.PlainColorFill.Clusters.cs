...
public partial class DotFillableExtensionTest
{
    ...
    public void does_not_overwrite_other_cluster_style_flags()
    {
        ...
        graph.Clusters.Add("", c =>
                c.Style.SetOptions(DotClusterFillStyle.None, DotBorderStyle.Solid, DotBorderWeight.Bold, DotCornerStyle.Rounded, true)
            )
            .SetPlainColorFill(Color.Red);

        graph.Clusters.Style.SetOptions(DotClusterFillStyle.None, DotBorderStyle.Solid, DotBorderWeight.Bold, DotCornerStyle.Rounded, true);

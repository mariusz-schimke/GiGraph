...
public partial class DotStripeFillableExtensionTest
{
    ...
    public void sets_striped_fill_on_individual_nodes()
    {
        ...
        Snapshot.Match(graph.ToDotString(), "striped_fill_on_individual_nodes");
    }
    ...
    public void sets_striped_fill_on_individual_node_groups()
    {
        ...
        Snapshot.Match(graph.ToDotString(), "striped_fill_on_individual_node_groups");
    }
    ...
    public void sets_striped_fill_on_node_collection()
    {
        ...
        Snapshot.Match(graph.ToDotString(), "striped_fill_on_node_collection_params");

        graph = new DotGraph();
        graph.Nodes.SetStripedFill(new DotMulticolor(Color.Red, Color.Blue));
        Snapshot.Match(graph.ToDotString(), "striped_fill_on_node_collection_multicolor");

        graph = new DotGraph();
        graph.Nodes.SetStripedFill(DotNodeShape.Rect, Color.Red, Color.Blue);
        Snapshot.Match(graph.ToDotString(), "striped_fill_on_node_collection_params_and_shape");

        graph = new DotGraph();
        graph.Nodes.SetStripedFill(DotNodeShape.Rectangle, new DotMulticolor(Color.Red, Color.Blue));
        Snapshot.Match(graph.ToDotString(), "striped_fill_on_node_collection_multicolor_and_shape");
    }
}
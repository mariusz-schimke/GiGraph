...
public partial class DotFillableExtensionTest
{
    ...
    public void sets_radial_gradient_fill_on_node()
    {
        ...
        Snapshot.Match(graph.ToDotString(), "radial_gradient_fill_on_nodes");
    ...
    public void sets_radial_gradient_fill_on_node_group()
    {
        ...
        Snapshot.Match(graph.ToDotString(), "radial_gradient_fill_on_node_groups");
    }
    ...
    public void sets_radial_gradient_fill_on_node_collection()
    {
        ...
        Snapshot.Match(graph.ToDotString(), "radial_gradient_fill_on_node_collection");
    }
    ...
    public void sets_radial_gradient_fill_with_angle_on_node_collection()
    {
        ...
        Snapshot.Match(graph.ToDotString(), "radial_gradient_fill_on_node_collection_with_angle");
    }
}
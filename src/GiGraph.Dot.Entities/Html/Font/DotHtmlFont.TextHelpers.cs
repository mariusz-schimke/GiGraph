...
namespace GiGraph.Dot.Entities.Html.Font
{
    public partial class DotHtmlFont
    {
        ...
        {
            return SetFont(font, (IEnumerable<(string Text, DotFontStyles Style)>) items);
        }
        ...
        ///     The font and style to apply.
        /// </param>
        public static DotHtmlEntity SetFont(DotStyledFont font, IEnumerable<(string Text, DotFontStyles Style)> items)
        {

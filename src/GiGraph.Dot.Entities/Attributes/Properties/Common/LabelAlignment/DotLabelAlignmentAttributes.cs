...
{
    public class DotLabelAlignmentAttributes : DotNestedEntityAttributes<IDotLabelAlignmentAttributes, DotLabelAlignmentAttributes>, IDotLabelAlignmentAttributes
    {

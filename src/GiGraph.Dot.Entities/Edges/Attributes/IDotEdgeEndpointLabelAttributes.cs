namespace GiGraph.Dot.Entities.Edges.Attributes
{
    public interface IDotEdgeEndpointLabelAttributes
    {
        ...
        ///     <see cref="DotEdgeEndpointAttributes.Label" /> on the <see cref="IDotEdgeAttributesRoot.HeadAttributes" /> and the
        ///     <see cref="IDotEdgeAttributesRoot.TailAttributes" /> attributes of the edge). The default distance is 10 points, the minimum
        ...
        ///         <see cref="IDotEdgeAttributesRoot.HeadAttributes" /> and on the <see cref="IDotEdgeAttributesRoot.TailAttributes" />
        ///         attributes of the edge). The origin in the coordinate system is the point where the edge touches the node. The ray of 0
        ///         degrees goes from the origin back along the edge, parallel to the edge at the origin.
        ///     </para>
        ///     <para>

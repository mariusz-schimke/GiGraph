namespace GiGraph.Dot.Entities.Edges.Attributes
{
    public interface IDotEdgeEndpointLabelAttributes
    {
        ...
        ///     <see cref="DotEdgeEndpointAttributes.Label" /> on the head and the tail of the edge). The default distance is 10 points, the
        ...
        ///         head/tail in polar coordinates (see <see cref="DotEdgeEndpointAttributes.Label" /> on the head and on the tail of the

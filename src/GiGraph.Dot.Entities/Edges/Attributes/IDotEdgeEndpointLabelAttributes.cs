namespace GiGraph.Dot.Entities.Edges.Attributes
{
    public interface IDotEdgeEndpointLabelAttributes
    {
        ...
        ///     <see cref="DotEdgeEndpointAttributes.Label" /> on the <see cref="DotEdgeAttributes.HeadAttributes" /> and the
        ///     <see cref="DotEdgeAttributes.TailAttributes" /> attributes of the edge). The default distance is 10 points, the minimum is 0.0. See
        ///     also <see cref="Angle" />.
        /// </summary>
        ...
        ///         <see cref="DotEdgeAttributes.HeadAttributes" /> and on the <see cref="DotEdgeAttributes.TailAttributes" /> attributes of the edge). The

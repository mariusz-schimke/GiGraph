...
using GiGraph.Dot.Entities.Tests.EscapeString;
...
namespace GiGraph.Dot.Entities.Tests.Html
{
    public class DotHtmlAttributeValueEscapingTest
    {
        ...
        {
            var value = $"String value {DotEscapeStringTest.SpecialChars} {SpecialChars}";
        ...
        {
            var value = (DotEscapeString) $"Escape string value {DotEscapeStringTest.SpecialChars} {SpecialChars}";
            var element = new DotHtmlVoidElement("element");
            element.Attributes.Set("attribute", value);
        ...
        {
            var value = $"Unchanged value {DotEscapeStringTest.SpecialChars} {SpecialChars}";
            var element = new DotHtmlVoidElement("element");

...
public partial class DotHtmlTableTableCellHyperlinkAttributes : DotEntityAttributes<IDotHtmlTableTableCellHyperlinkAttributes, DotHtmlTableTableCellHyperlinkAttributes>, IDotHtmlTableTableCellHyperlinkAttributes
{
    ...
    /// </param>
    public virtual DotHtmlTableTableCellHyperlinkAttributes Set(DotEscapeString? href = null, DotEscapeString? target = null, DotEscapeString? tooltip = null, DotEscapeString? title = null)
    {
        Href = href;
        Target = target;
        Tooltip = tooltip;
    ...
    /// </param>
    public virtual DotHtmlTableTableCellHyperlinkAttributes Set(DotHyperlink attributes) => Set(attributes.Href, attributes.Target, attributes.Tooltip, attributes.Title);
}
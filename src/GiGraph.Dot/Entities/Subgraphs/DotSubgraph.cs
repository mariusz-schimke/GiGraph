...
/// <summary>
///     <para>
///         Represents a subgraph as a collection of nodes that may be constrained within one rank (see <see cref="DotRank"/>). Use a
///         subgraph when you want to have more granular control on the layout or style of the nodes it contains. However, when you

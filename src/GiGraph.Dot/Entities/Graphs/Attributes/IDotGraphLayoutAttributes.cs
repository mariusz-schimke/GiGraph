...
public interface IDotGraphLayoutAttributes
{
    ...
    /// <summary>
    ///     <para>
    ///         In dot, this gives the desired rank separation, in inches (<see cref="DotRankSpacing"/>; default: 0.5, minimum: 0.02).
    ...
    ///         this can also be a list of doubles (<see cref="DotRadialSpacing"/>). The first double specifies the radius of the
    ...
    ///     </para>
    /// </summary>
    DotRankSpacingDefinition? RankSpacing { get; set; }

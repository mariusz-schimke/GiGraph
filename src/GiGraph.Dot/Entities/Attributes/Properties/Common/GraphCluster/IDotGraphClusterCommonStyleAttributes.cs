...
public interface IDotGraphClusterCommonStyleAttributes
{
    ...
    ///         only), and the <see cref="DotGraphFillStyle.Normal" /> fill style is used, a linear gradient fill is done.
    ///     </para>
    ///     <para>
    ...
    ///         <see cref="DotGraphFillStyle.Normal" /> fill style is specified (default: <see cref="System.Drawing.Color.Black" />).

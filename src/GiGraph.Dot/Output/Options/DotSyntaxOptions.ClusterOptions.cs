...
public partial class DotSyntaxOptions
{
    ...
    {
        /// <summary>
        ///     When set to <see langword="true" />, subgraphs will have the "cluster" attribute set to <see langword="true" /> to turn them
        ///     semantically into clusters. When set to <see langword="false" /> (default), on the other hand, they will have their
        ///     identifiers prefixed with the "cluster" keyword for this purpose. See also <see cref="ClusterIdSeparator" /> as the context
        ...
        ///     in a format "cluster identifier", where 'identifier' is any string used as a cluster identifier.
        /// </summary>

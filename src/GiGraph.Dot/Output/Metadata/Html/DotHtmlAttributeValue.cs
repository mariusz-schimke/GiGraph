...
public static class DotHtmlAttributeValue
{
    ...
    public static TEnum Get<TEnum>(string dotValue)
        where TEnum : Enum => DotAttributeValue<DotHtmlAttributeValueAttribute>.Get<TEnum>(dotValue);
    ...
    public static Dictionary<TEnum, string> GetMapping<TEnum>()
        where TEnum : Enum => DotAttributeValue<DotHtmlAttributeValueAttribute>.GetMapping<TEnum>();

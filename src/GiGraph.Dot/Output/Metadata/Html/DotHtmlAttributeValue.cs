...
public static class DotHtmlAttributeValue
{
    ...
    public static string GetAsFlags(Enum flags, bool sort = true) =>
        DotAttributeValue<DotHtmlAttributeValueAttribute>.GetAsFlags<DotHtmlJoinableTypeAttribute>(flags, sort);
    ...
    ///     The enumeration value whose associated DOT value to return.
    /// </param>
    public static string? Get(Enum value) => DotAttributeValue<DotHtmlAttributeValueAttribute>.Get(value);
    ...
    public static bool TryGet<TEnum>(string dotValue, [MaybeNullWhen(false)] out TEnum value)
        where TEnum : struct, Enum => DotAttributeValue<DotHtmlAttributeValueAttribute>.TryGet(dotValue, out value);
    ...
    public static TEnum Get<TEnum>(string dotValue)
        where TEnum : struct, Enum => DotAttributeValue<DotHtmlAttributeValueAttribute>.Get<TEnum>(dotValue);
    ...
    ///     The DOT attribute value whose associated enumeration value to return.
    /// </param>
    public static Enum Get(Type enumType, string dotValue) => DotAttributeValue<DotHtmlAttributeValueAttribute>.Get(enumType, dotValue);
    ...
    public static Dictionary<TEnum, string?> GetMapping<TEnum>()
        where TEnum : struct, Enum => DotAttributeValue<DotHtmlAttributeValueAttribute>.GetMapping<TEnum>();
    ...
    ///     The type of the enumeration whose value mapping to get.
    /// </param>
    public static Dictionary<Enum, string?> GetMapping(Type enumType) => DotAttributeValue<DotHtmlAttributeValueAttribute>.GetMapping(enumType);
}
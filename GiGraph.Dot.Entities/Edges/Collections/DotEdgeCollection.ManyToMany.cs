...
namespace GiGraph.Dot.Entities.Edges.Collections
{
    ...
    {
        /// <summary>
        ///     Adds a group of edges where all <paramref name="tailNodeIds" /> as tail nodes are connected to all
        ...
        ///     The identifiers of the head (destination, right) nodes.
        /// </param>
        /// <param name="init">
        ...
        /// <summary>
        ///     Adds a group of edges where all nodes in the specified tail endpoint group is connected to all nodes in the specified head
        ///     endpoint group.
        /// </summary>
        /// <param name="tail">
        ...
        /// <summary>
        ///     Adds a group of edges where all nodes in the specified tail subgraph is connected to all nodes in the specified head
        ///     subgraph.
        /// </summary>
        /// <param name="tail">

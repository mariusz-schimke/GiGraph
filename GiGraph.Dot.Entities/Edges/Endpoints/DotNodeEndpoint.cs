...
namespace GiGraph.Dot.Entities.Edges.Endpoints
{
    ...
    /// To make such connection, use <see cref="DotEdge{TTail, THead}"/> or <see cref="DotWalk"/>.
    /// </summary>
    public class DotNodeEndpoint : DotEndpoint
    {
        ...
        ///     the default value is <see cref="DotCompassPoint.Center"/>.
        /// </param>
        public DotNodeEndpoint(string nodeId, string portName = null, DotCompassPoint? compassPoint = null)
        {
            NodeId = nodeId;
            PortName = portName;

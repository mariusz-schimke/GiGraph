...
namespace GiGraph.Dot.Entities.Attributes.Enums
{
    ...
    public enum DotStyle
    {
        ...
        ///     element on a graph or a subgraph level, using <see cref="DotCommonGraph.EdgeDefaults" /> or
        ///     <see cref="DotCommonGraph.NodeDefaults" />.
        /// </summary>
        Default = 0,
        ...
        ///     are specified via a color list (see <see cref="DotColorList" />), and drawn from left to right in list order. Optional color
        ...
        ///     list (see <see cref="DotColorList" />), with the colors drawn counter-clockwise starting at angle 0. Optional color weights

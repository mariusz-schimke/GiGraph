...
{
    /// <summary>
    ///     Represents a simple (<see cref="DotColor" />) or a complex (<see cref="DotColorList" />) color definition. If the value
    ///     specifies multiple colors, with no weights (<see cref="DotColorList" /> with <see cref="DotColor" /> items), and a
    ///     <see cref="DotStyle.Filled" /> style is specified, a linear gradient fill is done using the first two colors. If weights are
    ///     present (<see cref="DotColorList" /> with <see cref="DotWeightedColor" /> items), a degenerate linear gradient fill is done.
    ...
    public class DotColorDefinitionAttribute : DotAttribute<DotColorDefinition>
    {
        ...
        ///     The value of the attribute as a color definition. Use <see cref="DotColor" /> or <see cref="DotColorList" />.
        /// </param>

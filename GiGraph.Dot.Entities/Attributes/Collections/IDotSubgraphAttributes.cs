...
namespace GiGraph.Dot.Entities.Attributes.Collections
{
    public interface IDotSubgraphAttributes : IDotAttributeCollection
    {
        ...
        /// </para>    
        /// <para>
        ///     If rank is <see cref="DotRank.Source"/>, all nodes are placed on the minimum rank, 
        ///     and the only nodes on the minimum rank belong to some subgraph whose rank attribute is 
        ///     <see cref="DotRank.Source"/> or <see cref="DotRank.Min"/>.
        /// </para>
        /// <para>

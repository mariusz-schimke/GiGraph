...
namespace GiGraph.Dot.Entities.Attributes.Collections
{
    public interface IDotNodeAttributes : IDotAttributeCollection, IDotFillable
    {
        ...
        /// <summary>
        /// External label for the node. The label will be placed outside of the node but near it.
        /// This can be useful in DOT to avoid the occasional problem when the use of edge labels distorts the layout.
        /// For other layouts, this attribute can be viewed as a synonym for the <see cref="Label"/> attribute.
        ...
        /// <summary>
        /// Gets or sets the value indicating how the size of the node is determined (default: <see cref="DotNodeSizing.Automatic"/>).
        /// </summary>

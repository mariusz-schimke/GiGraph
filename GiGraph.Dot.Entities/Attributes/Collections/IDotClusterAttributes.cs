...
namespace GiGraph.Dot.Entities.Attributes.Collections
{
    public interface IDotClusterAttributes : IDotAttributeCollection, IDotFillable
    {
        /// <summary>
        ///     <para>
        ///         Gets or sets the label to display on the cluster. It can be a string or an HTML (<see cref="DotLabelHtml" />).
        ///     </para>
        ///     <para>
        ...
        ///         or schlbk.pfa or schlbk.pfb in one of the directories specified by the <see cref="IDotGraphAttributes.FontPath" />

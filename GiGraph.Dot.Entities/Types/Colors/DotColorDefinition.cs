...
namespace GiGraph.Dot.Entities.Types.Colors
{
    ...
    public abstract class DotColorDefinition : IDotEncodable
    {
        ...
        /// <summary>
        ///     Creates a new color instance initialized with a color (<see cref="DotColor" />), or with a weighted color (
        ///     <see cref="DotWeightedColor" />) if <paramref name="weight" /> is specified. <see cref="DotWeightedColor" /> may be used in
        ///     color lists only (<see cref="DotColorList" />), where the weight specifies the area proportion for the color.
        /// </summary>
        /// <param name="color">
        ///     The color to initialize the instance with.
        /// </param>
        /// <param name="weight">
        ///     The optional weight of the color in the range 0 ≤ <paramref name="weight" /> ≤ 1. Use only if the returned color will be an
        ///     item of a color lists (<see cref="DotColorList" />).
        /// </param>
        ...
        ///         nodes or clusters with the <see cref="DotStyle.Striped" /> style, the returned color definition will be rendered as a
        ///         striped multicolor fill, or as a wedged multicolor fill, when used for elliptically-shaped nodes with the
        ...
        ///         rectangularly-shaped nodes or clusters with the <see cref="DotStyle.Striped" /> style, the returned color definition will
        ///         be rendered as a striped multicolor fill, or as a wedged multicolor fill, when used for elliptically-shaped nodes with
        ///         the <see cref="DotStyle.Wedged" /> style.
        ///     </para>
        /// </summary>
        /// <param name="colors">

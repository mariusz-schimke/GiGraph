...
{
    /// <summary>
    ///     Represents the scaling mode of the graph. Accepts either a numeric value (<see cref="DotGraphScalingAspectRatio" />), or an enumerable
    ///     value (<see cref="DotGraphScaling" />).
    /// </summary>

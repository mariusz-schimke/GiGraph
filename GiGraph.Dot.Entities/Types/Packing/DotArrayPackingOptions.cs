...
namespace GiGraph.Dot.Entities.Types.Packing
{
    ...
    public enum DotArrayPackingOptions
    {
        ...
        ///     sort value by a non-negative integer using the <see cref="DotGraphLayoutAttributes.SortIndex" /> attribute of graph
        ///     <see cref="DotGraphAttributes.Layout" />, the <see cref="DotClusterAttributes.SortIndex" /> attribute on a cluster or the
        ///     <see cref="DotNodeAttributes.SortIndex" /> attribute on a cluster. Components are inserted in order, starting with the one

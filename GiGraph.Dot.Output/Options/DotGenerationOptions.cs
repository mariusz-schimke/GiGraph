...
namespace GiGraph.Dot.Output.Options
{
    public partial class DotGenerationOptions
    {
        ...
        /// <summary>
        ///     Gets or sets a value indicating if graph elements should be ordered alphabetically in the output DOT script. This setting
        ///     affects attributes, nodes, edges, subgraphs, and clusters. If false, all elements will be rendered in the order they were
        ///     added to individual graph element collections.
        ///     <para>

...
namespace GiGraph.Dot.Extensions
{
    ...
    public static class DotNodeToPolygonExtension
    {
        ...
        /// <param name="sides">The number of sides if <see cref="IDotNodeAttributes.Shape"/> is set to <see cref="DotShape.Polygon"/> (default: 4, minimum: 0).</param>
        ...
        /// <param name="skew">Skew factor for <see cref="IDotNodeAttributes.Shape"/> set to <see cref="DotShape.Polygon"/> (default: 0, minimum: -100).
        /// Positive values skew top of polygon to right; negative to left.</param>
        /// <param name="distortion">Distortion factor for <see cref="IDotNodeAttributes.Shape"/> set to <see cref="DotShape.Polygon"/> (default: 0, minimum: -100).
        ...
        {
            node.Attributes.Shape = DotShape.Polygon;
